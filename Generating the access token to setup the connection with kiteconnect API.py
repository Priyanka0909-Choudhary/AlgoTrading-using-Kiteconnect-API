# -*- coding: utf-8 -*-
"""
Created on Tue Apr 27 23:39:05 2021

@author: Priyanka Choudhary
"""
### In order to set up the connection with the Kiteconnect API 
### using the API Key, Secret and the login credentials of my zerodha demat account.
from kiteconnect import KiteConnect
from selenium import webdriver
import time
import os

# Save the login credentials in a folder and use that folder
cwd = os.chdir("D:\Algorithmic Trading_internship")

# Automating the process for login and extracting the request token
def autologin():
    ...
    #web scrapping to find the password and username boxes
...
#generating and storing access token (using the request token) - valid till 6 am the next day
